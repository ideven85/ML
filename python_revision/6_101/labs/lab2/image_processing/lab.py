...
w, h, c, p = "width", "height", "color", "pixels"
...
if __name__ == "__main__":
    ...
    # img_data = img.getdata()
    img_inverted = inverted(img)
    save_greyscale_image(img_inverted, "cat_inverted.png")
